...
//Compact, but makes dynamic configuration difficult within table
...
=== Connector List v3
// highly configurable. Links are in predictable location and release compatibility table can be generated without manipulation
