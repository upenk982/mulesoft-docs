...
|Data Gateway Administrator (Environment) |Data Gateway Admin |All (no restrictions)
|Data Gateway Viewer (Environment) |Data Gateway Viewer a|
* View gateways and logs
* View connections
* View notifications
* Contact Mulesoft
